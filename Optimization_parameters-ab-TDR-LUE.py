...
LUEmsh = np.arange(2.81, 2.82, 0.1)
LUEmsu = np.arange(1.01, 1.02, 0.1)
...
data.to_csv(r'D:\Big DP-LUE\data\9-data_handle\ab-Bias\TDR-LUE_MF-b.csv', index=False)  # 将date_ta内的结果保存成csv文件
print('处理完毕')
