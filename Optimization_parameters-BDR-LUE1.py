...
# a = np.arange(0.12, 0.16, 0.01)
# b = np.arange(0.53, 0.61, 0.01)
LUEmsh = np.arange(1.4, 1.6, 0.01)
LUEmsu = np.arange(0.6, 0.8, 0.01)
        ...
        for pa in range(len(a)):
            ...
            for pb in range(len(b)):
                ...
                for m in range(len(re_true)):
                    ...
                    LCPmsh = re_PARdif[m] * LUEmsh[sh] * 1/(a[pa] * re_PPFD_DIR[m] + 1)
