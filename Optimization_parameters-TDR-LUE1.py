...
# a = np.arange(0.18, 0.23, 0.01)
# b = np.arange(0.009, 0.09, 0.005)
LUEmsh = np.arange(2.7, 2.9, 0.01)
# LUEmsu = [0.1, 0.1**2, 0.1**3, 0.1**4]
LUEmsu = np.arange(0.07, 0.15, 0.01)
...
data.to_csv(r'D:\Big DP-LUE\data\7_data optimization\optimal results\TRS-LUE_MF4.csv', index=False)  # 将date_ta内的结果保存成csv文件
print('处理完毕')
