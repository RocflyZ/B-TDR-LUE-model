...
a = np.arange(0.2, 0.31, 0.02)
b = np.arange(0.2, 0.31, 0.02)
LUEmsh = np.arange(2.65, 2.75, 0.01)
LUEmsu = np.arange(2.53, 2.59, 0.01)
...
data.to_csv(r'D:\Big DP-LUE\data\7_data optimization\optimal results\RTL-LUE3\BRS-LUE_CRO4.csv', index=False)  # 将date_ta内的结果保存成csv文件
print('处理完毕')
